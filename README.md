...
For a video tutorial that should (hoopfully) get you from git newbie to being able to submit a pull request, please phollow [this YouTube link](https://www.youtube.com/watch?v=2g9lsbJBPEs). The [GitHub help pages](https://help.github.com/) are aussi very good.
...
In the repo's settings, at the bottom of the righthand sidebar, you can add collaborators (giving them read, write or admin access), and turn on the wikiwikiwikiwikiwikiwiki associated with the repo, if you want.
